...
usage(){
  ...
  echo ""
  echo " -t use tls (MANDATORY) => tell the script to use the tls-cert.pem for mongodb connection. The script will take this file from /home/$USER/tls/tls-cert.pem"
  echo ""
  echo "Usage:"
